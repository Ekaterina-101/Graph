...
int main(int argc, char* argv[]) {
    ...
    desc.add_options()
        ...
        ("degree,d", po::value<std::size_t>(&graph_degree)->default_value(3), "Maximum degree of graph")
    ...
    std::cout << "Maximum graph degree: " << graph_degree << std::endl;
    ...
    bruteForceGenerator.m_degree = graph_degree;
